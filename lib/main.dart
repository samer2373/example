...
import 'package:ar_flutter_plugin_example/examples/qibla_ar_view.dart';
import 'package:ar_flutter_plugin_example/firebase_options.dart';
...
class ExampleList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final examples = [
      ...
      Example(
          'Qibla Direction',
          'Show the direction of Qibla',
          () => Navigator.push(
              context, MaterialPageRoute(builder: (context) => QiblaARView()))),
